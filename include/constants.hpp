...
// Configuration
constexpr unsigned RENDER_WIDTH = 840;
constexpr unsigned RENDER_HEIGHT = 840;
...
constexpr double ROW_HEIGHT = static_cast<double>(RENDER_HEIGHT) / ROW_COUNT;
constexpr double COL_WIDTH = 2 * ROW_HEIGHT / std::numbers::sqrt3;
constexpr unsigned COL_COUNT = RENDER_WIDTH / (COL_WIDTH / 2);
